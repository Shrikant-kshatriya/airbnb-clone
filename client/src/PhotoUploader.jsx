  ...
  return (
    <>
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 lg:grid-cols-6 md:grid-cols-4">
          ...
          addedPhotos.map((link, index) => (
            <div className="h-32 flex relative" key={index}>
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3 cursor-pointer"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <label className="h-32 cursor-pointer flex items-center justify-center cursor-pointer gap-1 border bg-transparent rounded-2xl p-2 text-xl text-gray-600">
          <input
            type="file"
            className="hidden"
            multiple
